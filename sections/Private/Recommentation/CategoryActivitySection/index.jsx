...
const CategoryActivities = ({ dbCategory, dbActivity }) => {
  ...
  return (
    <section className={styles.section} >
      ...
      <div>
        {dbCategory && dbCategory.map((el) => <CustomSvgIcon key={el.id_categoria} el={el} svg={JavascriptSvg} />)}
{/*         <CustomSvgIcon name='JAVASCRIPT' svg={JavascriptSvg} AddCategoryAndActivitySelected={AddCategoryAndActivitySelected} />
      ...
      <div>
        {dbActivity && dbActivity.map((el) => <CustomSvgIcon key={el.id_actividad} el={el} svg={JavascriptSvg} />)}
        {/* <CustomSvgIcon name='JAVASCRIPT' svg={JavascriptSvg} AddCategoryAndActivitySelected={AddCategoryAndActivitySelected} />
        <CustomSvgIcon name='CORAZON' svg={HeartSvg} AddCategoryAndActivitySelected={AddCategoryAndActivitySelected}/>
        <CustomSvgIcon name='JAVASCRIPT' svg={JavascriptSvg} AddCategoryAndActivitySelected={AddCategoryAndActivitySelected} />
        <CustomSvgIcon name='CORAZON' svg={HeartSvg} AddCategoryAndActivitySelected={AddCategoryAndActivitySelected}/>
