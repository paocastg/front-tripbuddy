...
const SelectTripPage = () => {
  ...
  const componentChildren = [
    <SelectSection key="0" setShowSection={setShowSection} />,
    <FormSection key="1" setShowSection={setShowSection} />,
    <CategoryActivitiesSection key="2" setShowSection={setShowSection} />,
    <OtherActivitiesSection key="3" setShowSection={setShowSection} />,
    <ConfirmationSection key="4" setShowSection={setShowSection} />
  ]
  return (
    <Wrapper>
      <NextSeo title="Selecciona tu viaje" description="A short description goes here." />
      <SelectTripProvider>
